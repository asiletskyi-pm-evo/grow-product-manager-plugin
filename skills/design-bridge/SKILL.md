...
**Тригер**: Andrii каже "зробімо презентацію для direction review на базі концепту PROJ-109" (Q&A — Product Page Integration).
...
design-bridge:
  ...
  Step 3  → parse Confluence PROJ-109 page → Deck IR populated:
  ...
  Step 7  → attach to PROJ-109 Confluence page as attachment
            → comment in Jira PROJ-109 with computer:// link
