...
Follow `references/test-mode.md` — full sandbox procedure (TM-0..TM-5, isolation, finale diff, Discard/Promote/Keep, verification matrix). Triggers: "dry-run onboarding", "test mode", "тестовий режим".
