...
2. **Спринти** — каденс (дефолт 2 тижні), якір (назва+дата найближчого, напр. `Sprint 55 = 2026-06-29`), Jira board id.
3. **Мапа цілей** — епік → Ціль (PROJ-XX), бо Atlas Goals не запитуються через MCP.
