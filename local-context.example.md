...
#### Primary Market
- xx
<!-- ISO country code of the market whose holiday calendar and benchmark relevance apply -->

#### Test Accounts
<!-- labels and roles only — never passwords, tokens or one-time codes; you log in yourself before each walkthrough leg -->
| Label | Role | Surfaces | Access | Sandbox |
|-------|------|----------|--------|---------|
| test-buyer-1 | buyer | web, iphone-on-mac | https://example.com/wiki/test-accounts — phone login, code by e-mail | yes |
